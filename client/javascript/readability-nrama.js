...
THRESHOLD=0.01; //default .2
MIN_THRESHOLD=1; //default 10
//following means FF only
CSS_HREF = 'chrome://readability/content/style/readability.css' //default 'http://lab.arc90.com/experiments/readability/css/readability.css'
CSS_PRINT_HREF = 'chrome://readability/content/style/readability-print.css'//default 'http://lab.arc90.com/experiments/readability/css/readability-print.css';
 ...
 *
 * modified for note-o-rama --- allows space etc, can only be used as FF extension
 * with the CSS links defined as CHROME
 *
...
var readability = {
    ...
    maxPages:    30, //*default 30 /* The maximum number of pages to loop through before we call it quits and just show a link. */
    ...
    regexps: {
        ...
        positive:              /article|articleText|articleText_indent|body|content|entry|hentry|main|page|pagination|post|text|blog|story/i,
    ...
    init: function() {
		...
		nrama_stickies = readability.removeStickies(document);
	...
	overlay.appendChild( innerDiv       );
        ...
        if(nrama_stickies){
	        document.body.append(nrama_stickies);
	       }
	...
	_readability_css.href=CSS_HREF;
	_readability_css.type='text/css';
	_readability_css.media='all';
	document.documentElement.appendChild(_readability_css);
	_readability_print_css=document.createElement('link');
	_readability_print_css.rel='stylesheet';
	_readability_print_css.href=CSS_PRINT_HREF;
	...
	*
	**/
	removeStickies : function(document) {
	 nrama_stickies = document.getElementById("stickiesContainer");
	 if(nrama_stickies) {
		 nrama_stickies.parentNode.removeChild(nrama_stickies);
		}
		return nrama_stickies;
	},
    ...
    **/
    grabArticle: function (page) {
        ...
        **/
        ...
        var siblingScoreThreshold = Math.max(MIN_THRESHOLD, topCandidate.readability.contentScore * THRESHOLD);
